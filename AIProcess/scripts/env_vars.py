...
AI_PROCESS_SERVICE_ADDRESS = 'AI_PROCESS_SERVICE_ADDRESS'
AI_PROCESS_SERVICE_PORT = 'AI_PROCESS_SERVICE_PORT'

ENV_VARS_DICT = {DISCOVERY_SERVICE_ADDRESS: 'localhost',
             DISCOVERY_SERVICE_PORT: 8002,
             AI_PROCESS_SERVICE_ADDRESS: 'localhost',
            AI_PROCESS_SERVICE_PORT: 8001
             }
